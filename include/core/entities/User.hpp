...
private:
  ...
  std::string
      _input_path; /*!< Caminho do diretório de entrada de músicas do usuário */
...
public:
  ...
  User(const std::string &_username, const std::string &_home_path,
       const std::string &_input_path, const userid &_uid);
